            ...
            stage('echo 打印参数') {
                steps {
                    script {
                        ...
                        echo "${env.AWS_ACCESS_IAM_AWSAccessKeyId}"
                    }
                    withCredentials([usernamePassword(credentialsId: 'aws-iam-fly-devops', accessKeyVariable: 'AWS_ACCESS_KEY_ID', secretKeyVariable: 'AWS_SECRET_ACCESS_KEY')]) {
